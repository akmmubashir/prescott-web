            ...
            <div className='relative z-20 h-dvh max-lg:gap-[40px_0] p-[160px_0px_60px] max-xl:p-[140px_40px_60px] max-lg:p-[100px_20px_40px] max-w-300 mx-auto flex flex-col justify-between'>
                <div className='relative max-lg:flex flex-col gap-4'>
                    ...
                    <motion.div
                        ...
                        className='w-full flex lg:justify-center lg:mt-10 gap-3'
                    >
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className='cursor-pointer uppercase text-[16px] max-md:text-[14px] p-[12px_20px] max-md:p-[8px_12px] rounded-lg bg-[#244952] border border-[#244952] hover:border-white hover:bg-white text-white hover:text-black transition-colors duration-300 font-medium shadow-2xl'
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className='cursor-pointer uppercase text-[16px] max-md:text-[14px] p-[12px_20px] max-md:p-[8px_12px] rounded-lg bg-white/20 border border-white hover:border-white hover:bg-white/10 text-white transition-colors duration-300 font-medium shadow-2xl'
                        >
                            Explore Now
                        </motion.button>
                    </motion.div>
